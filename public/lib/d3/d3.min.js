!function () {
    ...
    function Y() {
        var n = ".dragsuppress-" + ++Pa, t = "click" + n, r = oa.select(fa).on("touchmove" + n, y).on("dragstart" + n, y).on("selectstart" + n, y);
        if (Da) {
            var e = sa.style, u = e[Da];
            e[Da] = "none"
        }
        return function (i) {
            function o() {
    ...
    function wt(n, t, r) {
        ...
        var e = pt((.4124564 * n + .3575761 * t + .1804375 * r) / Qa), u = pt((.2126729 * n + .7151522 * t + .072175 * r) / nc), i = pt((.0193339 * n + .119192 * t + .9503041 * r) / tc);
    ...
    function Ct(n, t, r, e) {
        ...
        var i = {}, o = oa.dispatch("beforesend", "progress", "load", "error"), a = {}, c = new XMLHttpRequest, l = null;
    ...
    function Pt(n) {
        ...
        return function (n) {
            var r = hc.exec(n), e = r[1] || " ", o = r[2] || ">", a = r[3] || "", c = r[4] || "", l = r[5], s = +r[6], f = r[7], h = r[8], g = r[9], p = 1, v = "", d = "", m = !1;
            ...
            return function (n) {
                ...
                !l && f && (M = i(M));
                var b = v.length + M.length + _.length + (y ? 0 : u.length), w = s > b ? new Array(b = s - b + 1).join(e) : "";
    ...
    function Ot(n) {
        function t(n) {
            ...
            return t.parse = function (t) {
                ...
                var i = null != e.Z && vc !== jt, o = new (i ? jt : vc);
        ...
        var x = oa.map(), M = Yt(v), _ = Zt(v), b = Yt(d), w = Zt(d), S = Yt(m), k = Zt(m), E = Yt(y), N = Zt(y);
    ...
    function ir(n) {
        var t = n.getTimezoneOffset(), r = t > 0 ? "-" : "+", e = ~~(Ma(t) / 60), u = Ma(t) % 60;
    ...
    function gr() {
        function n(n, t) {
            n *= Ia, t = t * Ia / 2 + Ua / 4;
            var r = n - e, o = r >= 0 ? 1 : -1, a = o * r, c = Math.cos(t), l = Math.sin(t), s = i * l, f = u * c + s * Math.cos(a), h = s * o * Math.sin(a);
    ...
    function Mr(n, t) {
        var r = t[0] - n[0], e = t[1] - n[1], u = t[2] - n[2];
    ...
    function Er() {
        function n(n, u) {
            n *= Ia;
            var i = Math.cos(u *= Ia), o = i * Math.cos(n), a = i * Math.sin(n), c = Math.sin(u), l = Math.atan2(Math.sqrt((l = r * c - e * a) * l + (l = e * o - t * c) * l + (l = t * a - r * o) * l), t * o + r * a + e * c);
    ...
    function Ar() {
        function n(n, t) {
            n *= Ia;
            var r = Math.cos(t *= Ia), o = r * Math.cos(n), a = r * Math.sin(n), c = Math.sin(t), l = u * c - i * a, s = i * o - e * c, f = e * a - u * o, h = Math.sqrt(l * l + s * s + f * f), g = e * o + u * a + i * c, p = h && -W(g) / h, v = Math.atan2(h, g);
    ...
    function Lr(n, t, r, e, u) {
        ...
        if (n.forEach(function (n) {
                if (!((t = n.length - 1) <= 0)) {
                    ...
                    var c = new Tr(r, n, null, !0), l = new Tr(r, null, c, !1);
            ...
            for (var s, f, h = i[0]; ;) {
                ...
                do {
                    if (g.v = g.o.v = !0, g.e) {
                        if (p)for (var a = 0, l = s.length; l > a; ++a)u.point((f = s[a])[0], f[1]); else e(g.x, g.n.x, 1, u);
                        g = g.n
                    } else {
                        if (p) {
                            s = g.p.z;
    ...
    function zr(n, t, r, e, u) {
        return function (i, o) {
            ...
            function g() {
                ...
                var n, t = _.clean(), r = M.buffer(), e = r.length;
                if (d.pop(), v.push(d), d = null, e) {
                    if (1 & t) {
                        n = r[0];
                        var u, e = n.length - 1, i = -1;
            ...
            var p, v, d, m = t(o), y = i.invert(e[0], e[1]), x = {
                point: a,
                lineStart: l,
                lineEnd: s,
    ...
    function Ur(n, t) {
        ...
        for (var a = 0, c = t.length; c > a; ++a) {
            ...
            if (s)for (var f = l[0], h = f[0], g = f[1] / 2 + Ua / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ;) {
                d === s && (d = 0), n = l[d];
                var m = n[0], y = n[1] / 2 + Ua / 4, x = Math.sin(y), M = Math.cos(y), _ = m - h, b = _ >= 0 ? 1 : -1, w = b * _, S = w > Ua, k = p * x;
    ...
    function Fr(n, t, r, e) {
        var u;
        if (null == n)u = r * Ha, e.point(-Ua, u), e.point(0, u), e.point(Ua - Fa, u), e.point(Ua - Fa, 0), e.point(Ua - Fa, -u), e.point(0, -u), e.point(-Ua, -u), e.point(-Ua, 0), e.point(-Ua, u); else if (Ma(n[0] - t[0]) > Fa) {
            var i = -Ua, o = Ua - Fa, a = (n[0] < t[0] ? 1 : -1) * Ua;
    ...
    function Ir(n) {
        ...
        function r(n) {
            ...
            return {
                lineStart: function () {
                    ...
                    var g, p = [f, h], v = t(f, h), d = o ? v ? 0 : u(f, h) : v ? u(f + (0 > f ? Ua : -Ua), h) : 0;
                    if (!r && (l = c = v) && n.lineStart(), v !== c && (g = e(r, p), (br(r, g) || br(p, g)) && (p[0] += Fa, p[1] += Fa, v = t(p[0], p[1]))), v !== c)s = 0, v ? (n.lineStart(), g = e(p, r), n.point(g[0], g[1])) : (g = e(r, p), n.point(g[0], g[1]), n.lineEnd()), r = g; else if (a && r && o ^ v) {
                        var m;
        ...
        function e(n, t, r) {
            var e = pr(n), u = pr(t), o = [1, 0, 0], a = dr(e, u), c = vr(a, a), l = a[0], s = c - l * l;
            if (!s)return !r && n;
            var f = i * c / s, h = -i * l / s, g = dr(o, a), p = yr(o, f), v = yr(a, h);
            mr(p, v);
            ...
            if (!(0 > x)) {
                ...
                w > S && (b = w, w = S, S = b);
                var N = S - w, A = Ma(N - Ua) < Fa, C = A || Fa > N;
        ...
        var i = Math.cos(n), o = i > 0, a = Ma(i) > Fa, c = be(n, 6 * Ia);
    ...
    function Zr(n, t, r, e) {
        ...
        return function (a) {
            ...
            var v, d, m, y, x, M, _, b, w, S, k, E = a, N = Dr(), A = Yr(n, t, r, e), C = {
                point: f,
                lineStart: h,
                lineEnd: g,
                polygonStart: function () {
    ...
    function $r(n, t) {
        ...
        xr(r);
        var e = vr(r, n.fromNormal), u = vr(r, n.toNormal), i = vr(r, t.fromNormal), o = vr(r, t.toNormal);
        return e > -Oa && Oa > u && i > -Oa && Oa > o ? r : Oa > e && u > -Oa && Oa > i && o > -Oa ? (r[0] = -r[0], r[1] = -r[1], r[2] = -r[2], r) : void 0
    }

    function Xr(n, t) {
        var r = vr(n, t.fromNormal), e = vr(n, t.toNormal);
    ...
    function Br(n) {
        ...
        function e(t, r, e, i) {
            if (null == t) {
                ...
                var c = u[a], l = _r(e > 0 ? c.to : c.from);
                i.point(l[0], l[1])
            }
        }
    ...
    function le(n) {
        ...
        function u(t, r, e, a, c, l, s, f, h, g, p, v, d, m) {
            var y = s - t, x = f - r, M = y * y + x * x;
            if (M > 4 * i && d--) {
                var _ = a + g, b = c + p, w = l + v, S = Math.sqrt(_ * _ + b * b + w * w), k = Math.asin(w /= S), E = Ma(Ma(w) - 1) < Fa || Ma(e - h) < Fa ? (e + h) / 2 : Math.atan2(b, _), N = n(E, k), A = N[0], C = N[1], L = A - t, q = C - r, T = x * L - y * q;
                (T * T / M > i || Ma((y * L + x * q) / M - .5) > .3 || o > a * g + c * p + l * v) && (u(t, r, e, a, c, l, A, C, E, _ /= S, b /= S, w, d, m), m.point(A, C), u(A, C, E, _, b, w, s, f, h, g, p, v, d, m))
            }
        }

        var i = .5, o = Math.cos(30 * Ia), a = 16;
    ...
    function pe(n) {
        ...
        }), h = 150, g = 480, p = 250, v = 0, d = 0, m = 0, y = 0, x = 0, M = Hc, _ = Nt, b = null, w = null, S = null;
    ...
    function _e(n, t) {
        function r(n, t) {
            var r = Math.cos(t), a = Math.cos(n) * r, c = Math.sin(n) * r, l = Math.sin(t), s = l * e + a * u;
            return [Math.atan2(c * i - s * o, a * e - l * u), G(s * i + c * o)]
        }

        var e = Math.cos(n), u = Math.sin(n), i = Math.cos(t), o = Math.sin(t);
        return r.invert = function (n, t) {
            var r = Math.cos(t), a = Math.cos(n) * r, c = Math.sin(n) * r, l = Math.sin(t), s = l * i - c * o;
    ...
    function Ae(n, t, r, e) {
        var u = Math.cos(t), i = Math.sin(t), o = Math.cos(e), a = Math.sin(e), c = u * Math.cos(n), l = u * Math.sin(n), s = o * Math.cos(r), f = o * Math.sin(r), h = 2 * Math.asin(Math.sqrt(tt(e - t) + u * o * tt(r - n))), g = 1 / Math.sin(h), p = h ? function (n) {
            var t = Math.sin(n *= h) * g, r = Math.sin(h - n) * g, e = r * c + t * s, u = r * l + t * f, o = r * i + t * a;
    ...
    function Ce() {
        function n(n, u) {
            var i = Math.sin(u *= Ia), o = Math.cos(u), a = Ma((n *= Ia) - t), c = Math.cos(a);
    ...
    function Re(n) {
        var t, r = ge(n), e = r.scale, u = r.translate, i = r.clipExtent;
    ...
    function Oe(n, t, r, e) {
        var u = n[0], i = r[0], o = t[0] - u, a = e[0] - i, c = n[1], l = r[1], s = t[1] - c, f = e[1] - l, h = (a * (c - l) - f * (u - i)) / (f * o - a * s);
        return [u + h * o, c + h * s]
    }
    ...
    function Xe(n) {
        for (var t, r, e, u, i = n.x, o = n.y, a = al._; a;)if (e = Be(a, o) - i, e > Fa)a = a.L; else {
            if (u = i - Je(a, o), !(u > Fa)) {
        ...
        if (al.insert(t, c), t || r) {
            ...
            tu(t), tu(r);
            var l = t.site, s = l.x, f = l.y, h = n.x - s, g = n.y - f, p = r.site, v = p.x - s, d = p.y - f, m = 2 * (h * d - g * v), y = h * h + g * g, x = v * v + d * d, M = {
                x: (d * y - g * x) / m + s,
                y: (h * x - v * y) / m + f
            };
    ...
    function Be(n, t) {
        ...
        if (!o)return -1 / 0;
        r = o.site;
        var a = r.x, c = r.y, l = c - t;
        if (!l)return a;
        var s = a - e, f = 1 / i - 1 / l, h = s / l;
    ...
    function Ge(n) {
        for (var t, r, e, u, i, o, a, c, l, s, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = ol, d = v.length; d--;)if (i = v[d], i && i.prepare())for (a = i.edges, c = a.length, o = 0; c > o;)s = a[o].end(), e = s.x, u = s.y, l = a[++o % c].start(), t = l.x, r = l.y, (Ma(e - t) > Fa || Ma(u - r) > Fa) && (a.splice(o, 0, new cu(ou(i.site, s, Ma(e - f) < Fa && p - u > Fa ? {
            x: f,
            y: Ma(t - f) < Fa ? r : p
        } : Ma(u - p) < Fa && h - e > Fa ? {x: Ma(r - p) < Fa ? t : h, y: p} : Ma(e - h) < Fa && u - g > Fa ? {
            x: h,
            y: Ma(t - h) < Fa ? r : g
        } : Ma(u - g) < Fa && e - f > Fa ? {x: Ma(r - g) < Fa ? t : f, y: g} : null), i.site, null)), ++c)
    }
    ...
    function nu(n) {
        ...
        if (t && r) {
            ...
            if (e !== i) {
                var o = u.x, a = u.y, c = e.x - o, l = e.y - a, s = i.x - o, f = i.y - a, h = 2 * (c * f - l * s);
                if (!(h >= -Oa)) {
                    var g = c * c + l * l, p = s * s + f * f, v = (f * g - l * p) / h, d = (c * p - s * g) / h, f = d + a, m = fl.pop() || new Qe;
    ...
    function eu(n, t) {
        var r = n.b;
        if (r)return !0;
        var e, u, i = n.a, o = t[0][0], a = t[1][0], c = t[0][1], l = t[1][1], s = n.l, f = n.r, h = s.x, g = s.y, p = f.x, v = f.y, d = (h + p) / 2, m = (g + v) / 2;
        if (v === g) {
            if (o > d || d >= a)return;
            if (h > p) {
                if (i) {
    ...
    function pu(n, t) {
        ...
        for (il = [], ol = new Array(n.length), al = new lu, ll = new lu; ;)if (u = cl, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))(i.x !== r || i.y !== e) && (ol[i.i] = new We(i), Xe(i), r = i.x, e = i.y), i = n.pop(); else {
            if (!u)break;
            $e(u.arc)
        }
        t && (ru(t), Ge(t));
    ...
    function Su(n, t) {
        var r, e, u, i, o, a = 0, c = 0, l = [], s = [];
        for (n += "", t += "", gl.lastIndex = 0, e = 0; r = gl.exec(t); ++e)r.index && l.push(t.substring(a, c = r.index)), s.push({
            i: l.length,
            x: r[0]
        }), l.push(null), a = gl.lastIndex;
        for (a < t.length && l.push(t.substring(a)), e = 0, i = s.length; (r = gl.exec(n)) && i > e; ++e)if (o = s[e], o.x == r[0]) {
            if (o.i)if (null == l[o.i + 1])for (l[o.i - 1] += o.x, l.splice(o.i, 1), u = e + 1; i > u; ++u)s[u].i--; else for (l[o.i - 1] += o.x + l[o.i + 1], l.splice(o.i, 2), u = e + 1; i > u; ++u)s[u].i -= 2; else if (null == l[o.i + 1])l[o.i] = o.x; else for (l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1), u = e + 1; i > u; ++u)s[u].i--;
            s.splice(e, 1), i--, e--
    ...
    function Zu(n) {
        var t = [n.a, n.b], r = [n.c, n.d], e = $u(t), u = Vu(t, r), i = $u(Xu(r, t, -u)) || 0;
    ...
    function Bu(n, t) {
        var r, e = [], u = [], i = oa.transform(n), o = oa.transform(t), a = i.translate, c = o.translate, l = i.rotate, s = o.rotate, f = i.skew, h = o.skew, g = i.scale, p = o.scale;
    ...
    function Pi(n) {
        ...
        if ((r = n.children) && (l = r.length)) {
            var r, e, u, i, o, a, c, l, s = 1 / 0, f = -1 / 0, h = 1 / 0, g = -1 / 0;
    ...
    function Fi(n, t, r) {
        ...
        if (e && (u || i)) {
            ...
            o *= o, e *= e;
            var c = .5 + (e - o) / (2 * a), l = Math.sqrt(Math.max(0, 2 * o * (e + a) - (e -= a) * e - o * o)) / (2 * a);
    ...
    function Qi(n, t, r, e) {
        function u() {
            var u = Math.min(n.length, t.length) > 2 ? Ki : Ji, c = e ? Wu : Ju;
    ...
    function ro(n, t) {
        null == t && (t = 10);
        var r = Xi(n), e = r[1] - r[0], u = Math.pow(10, Math.floor(Math.log(e / t) / Math.LN10)), i = t / e * u;
    ...
    function ao(n, t, r, e) {
        ...
        return o.invert = function (t) {
            ...
            var n = Xi(e), o = [], a = n[0], c = n[1], l = Math.floor(u(a)), s = Math.ceil(u(c)), f = t % 1 ? 2 : t;
            if (isFinite(s - l)) {
                if (r) {
    ...
    function so(n, t) {
        ...
        return r.domain = function (e) {
            ...
            return i = e(n.length < 2 ? (c + l) / 2 : c + s * o / 2, s), a = 0, t = {t: "rangePoints", a: arguments}, r
            ...
            return i = e(s + h * c, h), l && i.reverse(), a = h * (1 - o), t = {t: "rangeBands", a: arguments}, r
    ...
    function Mo(n) {
        ...
        var r = Pe, e = Ue, u = Cr, i = _o, o = i.key, a = .7;
    ...
    function qo(n) {
        ...
        var t = 1, r = n.length, e = n[0], u = e[0], i = e[1], o = [u, u, u, (e = n[1])[0]], a = [i, i, i, e[1]], c = [u, ",", i, "L", Do(Ul, o), ",", Do(Ul, a)];
    ...
    function Io(n) {
        ...
        var r = Pe, e = Pe, u = 0, i = Ue, o = Cr, a = _o, c = a.key, l = a, s = "L", f = .7;
        return t.x = function (n) {
    ...
    function Vo(n) {
        return function () {
            var t = n.apply(this, arguments), r = t[0], e = t[1] + Tl;
    ...
    function Ko(n, t, r, e) {
        ...
        if (!i) {
            ...
            i = u[r] = {
                ...
                var s = n.__data__, f = i.ease, h = i.delay, g = i.duration, p = lc, v = [];
    ...
    function ra(n, t, r) {
        ...
        function u(n, r) {
            var e = n[1] - n[0], u = e / r, i = oa.bisect(Kl, u);
        ...
        return e.invert = function (t) {
            ...
            var i = e.domain(), o = Xi(i), a = null == n ? u(o, 10) : "number" == typeof n && u(o, n);
    ...
    var aa = [].slice, ca = function (n) {
        return aa.call(n)
    }, la = document, sa = la.documentElement, fa = window;
    try {
    ...
    try {
        ...
        var pa = fa.Element.prototype, va = pa.setAttribute, da = pa.setAttributeNS, ma = fa.CSSStyleDeclaration.prototype, ya = ma.setProperty;
    ...
    oa.ascending = n, oa.descending = function (n, t) {
        ...
        var e, u = n.length, i = 0, o = -1, a = 0;
        if (1 === arguments.length)for (; ++o < u;)t(e = n[o]) && (i += (e - i) / ++a); else for (; ++o < u;)t(e = r.call(n, n[o], o)) && (i += (e - i) / ++a);
        return a ? i : void 0
    ...
    oa.range = function (n, t, r) {
        ...
        has: a, get: function (n) {
            ...
            return this[_a + n] = t
        }, remove: c, keys: l, values: function () {
            var n = [];
    ...
    oa.nest = function () {
        ...
        has: a, add: function (n) {
            ...
            return n = _a + n, n in this && delete this[n]
        }, values: l, size: s, empty: f, forEach: function (n) {
    ...
    var Sa = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g, ka = {}.__proto__ ? function (n, t) {
        n.__proto__ = t
    } : function (n, t) {
    ...
    oa.ns = {
        ...
        if (arguments.length < 2) {
            if ("string" == typeof n) {
                var r = this.node(), e = (n = N(n)).length, u = -1;
                if (t = r.classList) {
    ...
    var Da = "onselectstart" in la ? null : p(sa.style, "userSelect"), Pa = 0;
    oa.mouse = function (n) {
        return Z(n, x())
        ...
        function t(n, t, u, i, o) {
            return function () {
                ...
                function c() {
                    t(h, v) && (m.on(i + d, null).on(o + d, null), y(p && oa.event.target === f), g({type: "dragend"}))
                }

                var l, s = this, f = oa.event.target, h = s.parentNode, g = r.of(s, arguments), p = 0, v = n(), d = ".drag" + (null == v ? "" : "-" + v), m = oa.select(u()).on(i + d, a).on(o + d, c), y = Y(), x = t(h, v);
                e ? (l = e.apply(s, arguments), l = [l.x - x[0], l.y - x[1]]) : l = [0, 0], g({type: "dragstart"})
            }
        }

        var r = M(n, "drag", "dragstart", "dragend"), e = null, u = t(v, oa.mouse, X, "mousemove", "mouseup"), i = t(V, oa.touch, $, "touchmove", "touchend");
        return n.origin = function (t) {
            return arguments.length ? (e = t, n) : e
        }, oa.rebind(n, r, "on")
    };
    var Ua = Math.PI, ja = 2 * Ua, Ha = Ua / 2, Fa = 1e-6, Oa = Fa * Fa, Ia = Ua / 180, Ya = 180 / Ua, Za = Math.SQRT2, Va = 2, $a = 4;
    oa.interpolateZoom = function (n, t) {
        function r(n) {
            var t = n * y;
            if (m) {
                var r = Q(v), o = i / (Va * h) * (r * nt(Za * t + v) - K(v));
                return [e + o * l, u + o * s, i * r / Q(Za * t + v)]
            }
            return [e + n * l, u + n * s, i * Math.exp(Za * t)]
        }

        var e = n[0], u = n[1], i = n[2], o = t[0], a = t[1], c = t[2], l = o - e, s = a - u, f = l * l + s * s, h = Math.sqrt(f), g = (c * c - i * i + $a * f) / (2 * i * Va * h), p = (c * c - i * i - $a * f) / (2 * c * Va * h), v = Math.log(Math.sqrt(g * g + 1) - g), d = Math.log(Math.sqrt(p * p + 1) - p), m = d - v, y = (m || Math.log(c / i)) / Za;
        ...
        function l() {
            ...
            var e = this, i = oa.event.target, l = q.of(e, arguments), s = 0, f = oa.select(fa).on(A, n).on(C, r), g = t(oa.mouse(e)), p = Y();
            H.call(e), o(l)
        }
        ...
        function s() {
            ...
            function r() {
                ...
                if (1 === o.length) {
                    ...
                    var l = o[0], f = o[1], h = l[0] - f[0], g = l[1] - f[1];
                    d = h * h + g * g
                }
            }
            ...
            function i() {
                ...
                if (i) {
                    var s = (s = r[0] - n[0]) * s + (s = r[1] - n[1]) * s, f = d && Math.sqrt(s / d);
            ...
            var h, g = this, p = q.of(g, arguments), v = {}, d = 0, x = ".zoom-" + oa.event.changedTouches[0].identifier, M = "touchmove" + x, _ = "touchend" + x, b = oa.select(oa.event.target).on(M, i).on(_, f), w = oa.select(g).on(N, null).on(L, r), k = Y();
            H.call(g), r(), o(p)
        }
        ...
        function g() {
            var n = q.of(this, arguments), r = oa.mouse(this), i = t(r), l = Math.log(S.k) / Math.LN2;
        ...
        var p, v, d, m, x, _, b, w, S = {
            ...
            y: 0,
            k: 1
        }, k = [960, 500], E = Ba, N = "mousedown.zoom", A = "mousemove.zoom", C = "mouseup.zoom", L = "touchstart.zoom", q = M(n, "zoomstart", "zoom", "zoomend");
        return n.event = function (n) {
            n.each(function () {
                ...
                Hl ? oa.select(this).transition().each("start.zoom", function () {
                    ...
                    var r = k[0], e = k[1], u = r / 2, i = e / 2, o = oa.interpolateZoom([(u - S.x) / S.k, (i - S.y) / S.k, r / S.k], [(u - t.x) / t.k, (i - t.y) / t.k, r / t.k]);
                    return function (t) {
                        var e = o(t), c = r / e[2];
    ...
    var Xa, Ba = [0, 1 / 0], Ja = "onwheel" in la ? (Xa = function () {
    ...
    var Ka = 18, Qa = .95047, nc = 1, tc = 1.08883, rc = st.prototype = new rt;
    ...
    uc.forEach(function (n, t) {
        ...
        return r.parse = function (n, t) {
            ...
            function r() {
                ...
                for (; l > s;) {
                    var e = n.charCodeAt(s++), a = 1;
                    if (10 === e)u = !0; else if (13 === e)u = !0, 10 === n.charCodeAt(s) && (++s, ++a); else if (e !== c)continue;
                    return n.substring(t, s - a)
                }
                return n.substring(t)
            }

            for (var e, u, i = {}, o = {}, a = [], l = n.length, s = 0, f = 0; (e = r()) !== o;) {
    ...
    oa.geo.bounds = function () {
        ...
        function t(t, r) {
            ...
            if (m) {
                ...
                xr(o), o = _r(o);
                var c = t - p, l = c > 0 ? 1 : -1, v = o[0] * Ya * l, d = Ma(c) > 180;
                if (d ^ (v > l * p && l * t > v)) {
                    var y = o[1] * Ya;
                    y > g && (g = y)
        ...
        var t = Dc, r = Pc, e = Uc, u = t * t + r * r + e * e;
    ...
    var Hc = zr(Or, jr, Fr, [-Ua, -Ua / 2], Pr), Fc = 1e9;
    oa.geo.clipExtent = function () {
        var n, t, r, e, u, i, o = {
            stream: function (n) {
                return u && (u.valid = !1), u = i(n), u.valid = !0, u
            }, extent: function (a) {
                return arguments.length ? (i = Zr(n = +a[0][0], t = +a[0][1], r = +a[1][0], e = +a[1][1]), u && (u.valid = !1, u = null), o) : [[n, t], [r, e]]
            }
        };
        return o.extent([[0, 0], [960, 500]])
    }, oa.geo.distance = function (n, t) {
        var r, e = (t[0] - n[0]) * Ia, u = n[1] * Ia, i = t[1] * Ia, o = Math.sin(e), a = Math.cos(e), c = Math.sin(u), l = Math.cos(u), s = Math.sin(i), f = Math.cos(i);
    ...
    (oa.geo.conicEqualArea = function () {
        ...
        var t, r, e, u, i = oa.geo.albers(), o = oa.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), a = oa.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
            point: function (n, r) {
                t = [n, r]
            }
        };
        return n.invert = function (n) {
            ...
            return r = i.translate(t).clipExtent([[s - .455 * l, f - .238 * l], [s + .455 * l, f + .238 * l]]).stream(c).point, e = o.translate([s - .307 * l, f + .201 * l]).clipExtent([[s - .425 * l + Fa, f + .12 * l + Fa], [s - .214 * l - Fa, f + .234 * l - Fa]]).stream(c).point, u = a.translate([s - .205 * l, f + .212 * l]).clipExtent([[s - .214 * l + Fa, f + .166 * l + Fa], [s - .115 * l - Fa, f + .234 * l - Fa]]).stream(c).point, n
        }, n.scale(1070)
    };
    ...
    }, Jc = {point: te, lineStart: v, lineEnd: v, polygonStart: v, polygonEnd: v}, Wc = {
        point: ue,
        lineStart: ie,
        lineEnd: oe,
        polygonStart: function () {
    ...
    oa.geo.path = function () {
        ...
        return n.area = function (n) {
            ...
            return $c = Xc = -(Zc = Vc = 1 / 0), oa.geo.stream(n, u(Jc)), [[Zc, Vc], [$c, Xc]]
        ...
        function n() {
            var n = "function" == typeof e ? e.apply(this, arguments) : e, t = ye(-n[0] * Ia, -n[1] * Ia, 0).invert, u = [];
        ...
        var r, e, u, i, o, a, c, l, s, f, h, g, p = 10, v = p, d = 90, m = 360, y = 2.5;
    ...
    (oa.geo.stereographic = function () {
        ...
        var n = Re(De), t = n.center, r = n.rotate;
        ...
        function t(n) {
            ...
            var l = je(a), s = je(c), f = s[0] === l[0], h = s[s.length - 1] === l[l.length - 1], g = [];
    ...
    We.prototype.prepare = function () {
        ...
        function t(n) {
            ...
            return pu(r(n), a).cells.forEach(function (r, a) {
                var c = r.edges, l = r.site, s = t[a] = c.length ? c.map(function (n) {
                    var t = n.start();
                    return [t.x, t.y]
                }) : l.x >= e && l.x <= i && l.y >= u && l.y <= o ? [[e, o], [i, o], [i, u], [e, u]] : [];
                s.point = n[a]
            }), t
        }
        ...
        function r(n) {
            return n.map(function (n, t) {
                return {x: Math.round(i(n, t) / Fa) * Fa, y: Math.round(o(n, t) / Fa) * Fa, i: t}
            })
        }

        var e = Pe, u = Ue, i = e, o = u, a = hl;
        return n ? t(n) : (t.links = function (n) {
            ...
            return arguments.length ? t.clipExtent(n && [[0, 0], n]) : a === hl ? null : a && a[1]
        }, t)
    };
    var hl = [[-1e6, -1e6], [1e6, 1e6]];
        ...
        function i(n) {
            function i(n, t, r, e, u, i, o, a) {
                if (!isNaN(r) && !isNaN(e))if (n.leaf) {
                    var c = n.x, s = n.y;
                    if (null != c)if (Ma(c - r) + Ma(s - e) < .01)l(n, t, r, e, u, i, o, a); else {
                        var f = n.point;
            ...
            function l(n, t, r, e, u, o, a, c) {
                var l = .5 * (u + a), s = .5 * (o + c), f = r >= l, h = e >= s, g = (h << 1) + f;
                n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = xu()), f ? u = l : a = l, h ? o = s : c = s, i(n, t, r, e, u, o, a, c)
            }

            var s, f, h, g, p, v, d, m, y, x = Et(a), M = Et(c);
            if (null != t)v = t, d = r, m = e, y = u; else if (m = y = -(v = d = 1 / 0), f = [], h = [], p = n.length, o)for (g = 0; p > g; ++g)s = n[g], s.x < v && (v = s.x), s.y < d && (d = s.y), s.x > m && (m = s.x), s.y > y && (y = s.y), f.push(s.x), h.push(s.y); else for (g = 0; p > g; ++g) {
    ...
    var pl = function () {
        ...
        linear: pl, poly: zu, quad: function () {
            return Lu
        }, cubic: function () {
            return qu
        }, sin: function () {
            ...
            return Pu
        }, elastic: Uu, back: ju, bounce: function () {
            return Hu
        }
    }), dl = oa.map({
        "in": Nt, out: Au, "in-out": Cu, "out-in": function (n) {
            return Cu(Au(n))
        }
    });
    oa.ease = function (n) {
    ...
    oa.interpolateTransform = Bu, oa.layout = {}, oa.layout.bundle = function () {
        ...
        function n() {
            var n, l, f, h, g, p = {}, v = [], d = oa.range(i), m = [];
            for (r = [], e = [], n = 0, h = -1; ++h < i;) {
            ...
            for (o && d.sort(function (n, t) {
                ...
                e[y] = {index: y, startAngle: f, endAngle: l, value: (l - f) / n}, l += s
            }
        ...
        var r, e, u, i, o, a = {}, c = oa.dispatch("start", "tick", "end"), l = [1, 1], s = .9, f = yl, h = xl, g = -30, p = Ml, v = .1, d = .64, m = [], y = [];
        return a.tick = function () {
            ...
            var t, r, e, c = m.length, s = y.length, p = l[0], v = l[1];
    ...
    oa.layout.hierarchy = function () {
        ...
        function t(n, e) {
            ...
            if (u && (a = u.length))for (var a, c = -1, l = e + 1; ++c < a;)o += t(u[c], l); else i && (o = +i.call(r, n, e) || 0);
        ...
        var e = oa.layout.hierarchy(), u = [1, 1];
        ...
        function n(i) {
            var o = i.map(function (r, e) {
                return +t.call(n, r, e)
            }), a = +("function" == typeof e ? e.apply(this, arguments) : e), c = (("function" == typeof u ? u.apply(this, arguments) : u) - a) / oa.sum(o), l = oa.range(i.length);
    ...
    var bl = oa.map({
        "inside-out": function (n) {
            var t, r, e = n.length, u = n.map(vi), i = n.map(di), o = oa.range(e).sort(function (n, t) {
                return u[n] - u[t]
            }), a = 0, c = 0, l = [], s = [];
        ...
        silhouette: function (n) {
            ...
            var t, r, e, u, i, o, a, c, l, s = n.length, f = n[0], h = f.length, g = [];
    ...
    oa.layout.histogram = function () {
        ...
        function n(n, i) {
            ...
            var f = Si(s, Ei), h = Si(s, ki), g = Si(s, Ni), p = f.x - r(f, h) / 2, v = h.x + r(h, f) / 2, d = g.depth || 1;
        ...
        var t = oa.layout.hierarchy().sort(null).value(null), r = _i, e = [1, 1], u = !1;
        ...
        function n(n, i) {
            var o = r.call(this, n, i), a = o[0], c = u[0], l = u[1], s = null == t ? Math.sqrt : "function" == typeof t ? t : function () {
                return t
            };
        ...
        var t, r = oa.layout.hierarchy().sort(Ti), e = 0, u = [1, 1];
        ...
        function n(n, i) {
            ...
            var s = Yi(c), f = Zi(c), h = s.x - r(s, f) / 2, g = f.x + r(f, s) / 2;
        ...
        function t(r) {
            var i = r.children;
            if (i && i.length) {
                var o, a, c, l = f(r), s = [], h = i.slice(), p = 1 / 0, v = "slice" === g ? l.dx : "dice" === g ? l.dy : "slice-dice" === g ? 1 & r.depth ? l.dy : l.dx : Math.min(l.dx, l.dy);
                for (n(h, l.dx * l.dy / r.value), s.area = 0; (c = h.length) > 0;)s.push(o = h[c - 1]), s.area += o.area, "squarify" !== g || (a = e(s, v)) <= p ? (h.pop(), p = a) : (s.area -= s.pop().area, u(s, v, l, !1), v = Math.min(l.dx, l.dy), s.length = s.area = 0, p = 1 / 0);
        ...
        function u(n, t, r, e) {
            var u, i = -1, o = n.length, a = r.x, l = r.y, s = t ? c(n.area / t) : 0;
            if (t == r.dx) {
        ...
        var o, a = oa.layout.hierarchy(), c = Math.round, l = [1, 1], s = null, f = Vi, h = !1, g = "squarify", p = .5 * (1 + Math.sqrt(5));
    ...
    var Al = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(mt), Cl = [2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725].map(mt), Ll = [3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654].map(mt), ql = [3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081].map(mt);
    oa.scale.quantile = function () {
        ...
        function n() {
            var n = t.apply(this, arguments), i = r.apply(this, arguments), o = e.apply(this, arguments) + Tl, a = u.apply(this, arguments) + Tl, c = (o > a && (c = o, o = a, a = c), a - o), l = Ua > c ? "0" : "1", s = Math.cos(o), f = Math.sin(o), h = Math.cos(a), g = Math.sin(a);
        ...
        return n.innerRadius = function (r) {
            ...
            var n = (t.apply(this, arguments) + r.apply(this, arguments)) / 2, i = (e.apply(this, arguments) + u.apply(this, arguments)) / 2 + Tl;
    ...
    var Dl = [0, 2 / 3, 1 / 3, 0], Pl = [0, 1 / 3, 2 / 3, 0], Ul = [0, 1 / 6, 2 / 3, 1 / 6];
    oa.svg.line.radial = function () {
        ...
        function t(n, t, r, e) {
            var u = t.call(n, r, e), i = a.call(n, u, e), o = c.call(n, u, e) + Tl, s = l.call(n, u, e) + Tl;
        ...
        var n = oa.svg.diagonal(), t = Zo, r = n.projection;
    ...
    var jl = oa.map({
        circle: Bo, cross: function (n) {
            var t = Math.sqrt(n / 5) / 2;
            return "M" + -3 * t + "," + -t + "H" + -t + "V" + -3 * t + "H" + t + "V" + -t + "H" + 3 * t + "V" + t + "H" + t + "V" + 3 * t + "H" + -t + "V" + t + "H" + -3 * t + "Z"
        }, diamond: function (n) {
            var t = Math.sqrt(n / (2 * Il)), r = t * Il;
            return "M0," + -t + "L" + r + ",0" + " 0," + t + " " + -r + ",0" + "Z"
        }, square: function (n) {
            var t = Math.sqrt(n) / 2;
            return "M" + -t + "," + -t + "L" + t + "," + -t + " " + t + "," + t + " " + -t + "," + t + "Z"
        }, "triangle-down": function (n) {
            var t = Math.sqrt(n / Ol), r = t * Ol / 2;
    ...
    var Hl, Fl, Ol = Math.sqrt(3), Il = Math.tan(30 * Ia), Yl = [], Zl = 0;
    Yl.call = La.call, Yl.empty = La.empty, Yl.node = La.node, Yl.size = La.size, oa.transition = function (n) {
        ...
        var o = "transform" == n ? Bu : ku, a = oa.ns.qualify(n);
        ...
        function n(n) {
            n.each(function () {
                var n, l = oa.select(this), s = this.__chart__ || r, f = this.__chart__ = r.copy(), h = null == c ? f.ticks ? f.ticks.apply(f, a) : f.domain() : c, g = null == t ? f.tickFormat ? f.tickFormat.apply(f, a) : Nt : t, p = l.selectAll(".tick").data(h, f), v = p.enter().insert("g", ".domain").attr("class", "tick").style("opacity", Fa), d = oa.transition(p.exit()).style("opacity", Fa).remove(), m = oa.transition(p.order()).style("opacity", 1), y = Bi(f), x = l.selectAll(".domain").data([0]), M = (x.enter().append("path").attr("class", "domain"), oa.transition(x));
        ...
        var t, r = oa.scale.linear(), e = Vl, u = 6, i = 6, o = 3, a = [10], c = null;
    ...
    var Vl = "bottom", $l = {top: 1, right: 1, bottom: 1, left: 1};
    oa.svg.brush = function () {
        function n(i) {
            i.each(function () {
                var i = oa.select(this).style("pointer-events", "all").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)").on("mousedown.brush", u).on("touchstart.brush", u), o = i.selectAll(".background").data([0]);
                ...
                var s, f = oa.transition(i), h = oa.transition(o);
        ...
        function u() {
            ...
            function d(n, t, r) {
                var e, u, a = Bi(t), c = a[0], l = a[1], p = L[r], v = r ? f : s, d = v[1] - v[0];
            ...
            function m() {
                v(), S.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), oa.select("body").style("cursor", null), q.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), C(), w({type: "brushend"})
            }

            var x, M, _ = this, b = oa.select(oa.event.target), w = a.of(_, arguments), S = oa.select(_), k = b.datum(), E = !/^(n|s)$/.test(k) && c, N = !/^(e|w)$/.test(k) && l, A = b.classed("extent"), C = Y(), L = oa.mouse(_), q = oa.select(fa).on("keydown.brush", u).on("keyup.brush", p);
            if (oa.event.changedTouches ? q.on("touchmove.brush", v).on("touchend.brush", m) : q.on("mousemove.brush", v).on("mouseup.brush", m), S.interrupt().selectAll("*").interrupt(), A)L[0] = s[0] - L[0], L[1] = f[0] - L[1]; else if (k) {
                var T = +/w$/.test(k), z = +/^n/.test(k);
                M = [s[1 - T] - L[0], f[1 - z] - L[1]], L[0] = s[T], L[1] = f[z]
            } else oa.event.altKey && (x = L.slice());
            S.style("pointer-events", "none").selectAll(".resize").style("display", null), oa.select("body").style("cursor", b.style("cursor")), w({type: "brushstart"}), v()
        }

        var i, o, a = M(n, "brushstart", "brush", "brushend"), c = null, l = null, s = [0, 0], f = [0, 0], h = !0, g = !0, p = Bl[0];
        return n.event = function (n) {
            n.each(function () {
                var n = a.of(this, arguments), t = {x: s, y: f, i: i, j: o}, r = this.__chart__ || t;
                this.__chart__ = t, Hl ? oa.select(this).transition().each("start.brush", function () {
                    i = r.i, o = r.j, s = r.x, f = r.y, n({type: "brushstart"})
                }).tween("brush:brush", function () {
                    var r = Eu(s, t.x), e = Eu(f, t.y);
                    return i = o = null, function (u) {
                        s = t.x = r(u), f = t.y = e(u), n({type: "brush", mode: "resize"})
                    }
    ...
    var Xl = {
        ...
        se: "nwse-resize",
        sw: "nesw-resize"
    }, Bl = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []], Jl = pc.format = Mc.timeFormat, Wl = Jl.utc, Gl = Wl("%Y-%m-%dT%H:%M:%S.%LZ");
